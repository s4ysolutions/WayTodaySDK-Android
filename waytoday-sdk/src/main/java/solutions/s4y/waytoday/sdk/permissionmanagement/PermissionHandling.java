...
package solutions.s4y.waytoday.sdk.permissionmanagement;
...
public class PermissionHandling {
    ...
    public static void handleOnRequestPermissionsResult(Context context, int requestCode, Tracker tracker) {
        if (requestCode == REQUEST_ENABLE_LOCATION && tracker.isOn(context) && tracker.locationUpdater != null) {
            tracker.requestStart(context, tracker.locationUpdater);
        }
    }
}
